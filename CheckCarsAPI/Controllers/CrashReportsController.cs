...
namespace CheckCarsAPI.Controllers
{
    ...
    public class CrashReportsController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCrashReport(int id, CrashReport crashReport)
        {
            if (id != crashReport.ReportId)
            {
                return BadRequest();
            }
        ...
        private bool CrashReportExists(int id)
        {
            return _context.CrashReports.Any(e => e.ReportId == id);
        }
    }
}
